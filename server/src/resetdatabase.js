...
var initialData = {
  ...
  "users": {
    ...
    "1": {
      ...
      "password": "$2a$08$D8WIDQVa6jBpIMZej.rZjeDq1Hng.G8RtfX4kv0XxeVwOMQgCd3ri"
    },
    "2": {
...
function addIndexes(db, cb) {
  db.collection('feedItems').createIndex({ "contents.contents": "text" }, null, (err) => {
    if (err) {
      cb(err);
    } else {
      // Specify that a user's email must be unique amongst all documents in the users collection!
