          ...
          <div className="col-md-2">
            <div className={"dropdown"}>
              ...
              <ul className="dropdown-menu">
                <li className={hideElement(this.props.author._id !== getUserId())}><a onClick={(e) => this.onEditClick(e)}>Edit Status Update</a></li>
                <li className={hideElement(this.props.author._id !== getUserId())}><a onClick={(e) => this.onDelete(e)}>Delete Status Update</a></li>
